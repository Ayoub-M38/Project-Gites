                    ...
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="card mt-3">
                            ...
                            <a class="btn btn-primary p-3 m-2 font-weight-bold"
                               href="detailsGite.php?id=<?= $row['id'] ?>">Détails</a>
                            <a class="btn btn-warning p-3 m-2 font-weight-bold"
                               href="updateGite.php?id=<?= $row['id'] ?>">Mettre à jour</a>
                            <a class="btn btn-danger p-3 m-2 font-weight-bold"
                               href="deleteGite.php?id=<?= $row['id'] ?>">Supprimer</a>
...
<div class="container mt-5 col-lg-6">
    ...
    <form action="ConfirmupdateGite.php?id=<?= $row['id'] ?>"  method="post" enctype="multipart/form-data">

        <div class="form-group">
            <label for="nom_gite">Nom du gite : </label>
            <input type="text" value="<?= $row['nom_gite'] ?>" class="form-control" id="nom_gite" name="nom_gite" placeholder="test de valeur">
        </div>
        ...
        <div class="form-group">
            ...
            <br/>
            <input type="text" class="form-control" value="<?= $row['img_gite'] ?>" id="img_gite" name="img_gite">
            <!--<input value="<?= $row['img_gite'] ?>" type="file" id="img_gite" name="img_gite" accept="image/png, image/jpeg, image/svg">-->
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" value="<?= $row['date_arrivee'] ?>" id="date_arrivee" name="date_arrivee" placeholder="">
        </div>

        <div class="form-group">
            <label for="date_depart">Date de départ : </label>
            <input type="date" value="<?= $row['date_depart'] ?>" id="date_depart" name="date_depart" placeholder="">
        </div>
        ...
        <button type="submit" class="btn btn-success text-end ">Mettre à jour le gite</button>
    </form>
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="card mt-3">
                        ...
                        <div class="card-body ">
                            ...
                            <a href="updateGite.php?id=<?=$row ['id']?>" class="btn btn-warning">Mettre à jour</a>
                            <a href="deleteGite.php?id=<?=$row ['id']?>" class="btn btn-danger">Supprimer</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="card mt-3">
                        ...
                        <div class="card-body ">
                            ...
                            <a href="updateGite.php?id=<?=$row ['id']?>" class="btn btn-warning">Mettre à jour</a>
                            <a href="ConfirmdeleteGite.php?id=<?=$row ['id']?>" class="btn btn-danger">Supprimer</a>
                        </div>
                    </div>
                </div>
            </div>
